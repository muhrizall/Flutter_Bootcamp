...
class ProfilePage<C extends ProfileController> extends GetView<C> {
  ...
  PreferredSizeWidget buildAppBar(BuildContext context, UserData? user) {
    return AppBar(
      ...
      bottom: buildBottomAppBar(context, user),
  ...
  PreferredSizeWidget buildBottomAppBar(BuildContext context, UserData? user) {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    user != null ? user.userAsalSekolah! : '-',
                    style: const TextStyle(
                      fontSize: 12,
                      color: Colors.white,
                    ),
  ...
  Widget buildBody(BuildContext context, UserData? user) {
    return ListView(
      children: [
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              buildContentProfile(
                context: context,
                title: 'Jenis Kelamin',
                value: user != null ? user.userGender! : '-',
              ),
              buildContentProfile(
                context: context,
                title: 'Kelas',
                value: user != null ? user.userKelas! : '-',
              ),
              buildContentProfile(
                context: context,
                title: 'Sekolah',
                value: user != null ? user.userAsalSekolah! : '-',
              ),
