...
import '../../../data/model/exercise_result.dart';
...
class ExerciseQuestionsFormController extends GetxController {
  ...
  ExerciseQuestionsFormController(
      this.courseRepository, this.firebaseAuthService);
  ...
  Future<void> getQuestions() async {
    ...
    if (email != null) {
      List<QuestionListData> result = await courseRepository.getQuestions(
    ...
    if (email != null) {
      ...
      if (questionAnswers.length == 10) {
        ...
        if (submitAnswersResult == true) {
          ...
          ExerciseResultData? exerciseResult = await courseRepository
